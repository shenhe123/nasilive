...
import com.feicui365.live.widget.CameraPreviewFrameView;
...
public class LivePushActivity3 extends BaseMvpActivity<LivePushPresenter> implements LivePushContrat.View {

    //直播开始界面
    @BindView(R.id.spv_main)
    CameraPreviewFrameView spv_main;
...
/*   mProfile = new StreamingProfile();
        ...
        mMediaStreamingManager = new MediaStreamingManager(this, spv_main, SW_VIDEO_WITH_SW_AUDIO_CODEC);
    ...
    protected void initView() {
       ...
       // spv_main.setRenderer(new MyRenderer());
        room_type = "0";
        room_pricre = "0";
        room_password = "";
...
/* R.id.iv_manager,*//*
 R.id.iv_more})
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.iv_share_2:
                ...
                Glide.with(LivePushActivity3.this).load(startLive.getThumb()).into(new SimpleTarget<Drawable>() {
                    @Override
                    public void onResourceReady(@NonNull Drawable resource, @Nullable Transition<? super Drawable> transition) {
                        ShareDialog.Builder builder = new ShareDialog.Builder(LivePushActivity3.this);
            ...
            case R.id.iv_more:
                ...
                if (bottomList == null) {
                    ...
                    bottom_builder = new XPopup.Builder(LivePushActivity3.this);
                                    ...
                                    public void onSuccess(Response<String> response) {
                                        ...
                                        if (HttpUtils.getInstance().swtichStatus(data)) {
                                            ...
                                            if (null != datas) {
                                                ...
                                                CommentAnchorShopList commentShopList = new CommentAnchorShopList(LivePushActivity3.this, shopItems);
    ...
    public void endlive(BaseResponse endlive) {
        ...
        builder = new AlertDialog.Builder(LivePushActivity3.this).setTitle(WordUtil.getString(R.string.Live_Finish)).setCancelable(false)
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            Glide.with(LivePushActivity3.this).applyDefaultRequestOptions(new RequestOptions().centerCrop().diskCacheStrategy(DiskCacheStrategy.ALL)).load(imageFile).into(cover_iv);
...
*//*
        ...
        try {
            mProfile.setVideoQuality(StreamingProfile.VIDEO_QUALITY_HIGH1)
                    ...
                    .setStreamStatusConfig(new StreamingProfile.StreamStatusConfig(3))
                    .setSendingBufferProfile(new StreamingProfile.SendingBufferProfile(0.2f, 0.8f, 3.0f, 20 * 1000))
                    .setPublishUrl(startLive.getPush_url());//设置推流地址
        } catch (URISyntaxException e) {
            e.printStackTrace();
        }
        ...
        mMediaStreamingManager.setStreamStatusCallback(new StreamStatusCallback() {
            ...
            public void notifyStreamStatusChanged(StreamingProfile.StreamStatus streamStatus) {
                String a=streamStatus.toString();
            }
        });
     boolean aa=   mMediaStreamingManager.resume();
        ...
        switch (jsonObject.getString("Action")) {
            ...
            default:
                ...
                if (res.getAction().equals("RoomMessage") || res.getAction().equals("RoomAttentAnchor")) {
                    ...
                    setCaht(res);
                    if (!LivePushActivity3.this.isFinishing()) {
...
/*
    ...
    private void finishEndDialog() {
        if (null == cosXmlService) {
            ...
            if (null != startLive) {
                builder = new AlertDialog.Builder(LivePushActivity3.this).setTitle("结束直播").setCancelable(false)
