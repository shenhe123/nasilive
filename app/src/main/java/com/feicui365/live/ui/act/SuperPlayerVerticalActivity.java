...
import com.feicui365.live.socket.MessageBean;
import com.feicui365.live.socket.SocketClient;
import com.feicui365.live.socket.SocketMessageListener;
import com.feicui365.live.socket.SocketSendUtils;
...
public class SuperPlayerVerticalActivity extends BaseMvpActivity<SuperPlayerPresenter> implements SuperPlayerContrat.View
    ...
    protected void initData() {
        SocketClient.getInstance().setMessageListener(new SocketMessageListener() {
            @Override
            public void onJoinRoom(MessageBean successConn) {
                Log.e("123","123");
            }

            @Override
            public void onLeaveRoom(MessageBean successConn) {
                Log.e("123","123");
            }

            @Override
            public void onRoomMessage(MessageBean successConn) {
                Log.e("123","123");
            }

            @Override
            public void onGiftAnimation(JSONObject successConn) {

            }

            @Override
            public void onSystemMessage(JSONObject successConn) {

            }

            @Override
            public void onLiveGroupMemberJoinExit(JSONObject successConn) {

            }

            @Override
            public void onBroadcastStreamer(JSONObject successConn) {

            }

            @Override
            public void onRoomNotification(JSONObject successConn) {
    ...
    public void getLiveInfo(BaseResponse<LiveInfo> baseResponse) {
        ...
        if (is_fisrt) {
            ...
            SocketSendUtils.joinRoom(hotLive.getAnchorid());
            SocketSendUtils.sendRoomMessage(hotLive.getAnchorid(),"");
        }
