...
public class PhoneRegeditActivity2 extends BaseMvpActivity<LoginPresenter> implements LoginContract.View {
    ...
    protected int getLayoutId() {
        return R.layout.activity_phone_regedit_2;
    }
    ...
    protected void initView() {
        ...
        hideTitle(true);
        AppManager.getAppManager().finishOthersActivity(PhoneRegeditActivity2.class);
    }
