...
import com.feicui365.live.shop.fragment.SellerOrderFragment;
...
public class SellerOrderActivity extends BaseMvpActivity<ShopPresenter> implements ShopContract.View {
    ...
    private void initFragment() {
        mFragments.add(new SellerOrderFragment("0"));
        mFragments.add(new SellerOrderFragment("1"));
        mFragments.add(new SellerOrderFragment("2"));
        mFragments.add(new SellerOrderFragment("3"));
        mFragments.add(new SellerOrderFragment("4"));
    ...
    private void initTab() {
        ...
        mTitles.add(new LiveCategory("已发货"));
        mTitles.add(new LiveCategory("已完成"));
