...
public class UserRefundOrderInfoChildAdapter extends BaseQuickAdapter<OrderGoods, BaseViewHolder> {
    public UserRefundOrderInfoChildAdapter(@Nullable List<OrderGoods> data) {
