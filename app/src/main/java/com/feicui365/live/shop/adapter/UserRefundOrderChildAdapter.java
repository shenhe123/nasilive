...
public class UserRefundOrderChildAdapter extends BaseQuickAdapter<OrderGoods, BaseViewHolder> {
    public UserRefundOrderChildAdapter(@Nullable List<OrderGoods> data) {
