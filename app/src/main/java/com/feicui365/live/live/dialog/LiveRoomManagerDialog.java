...
import com.feicui365.live.live.fragment.LiveUserFragment;
...
import com.feicui365.live.live.fragment.LiveBanFragment;
import com.feicui365.live.live.fragment.LiveManagerFragment;
...
public class LiveRoomManagerDialog extends BaseDialogFragment2 implements LivePushContrat.View {
    ...
    LiveBanFragment liveBanFragment;

    public LiveRoomManagerDialog(String mAnchorId, int mType) {
    ...
    public void refreshData() {
        if (vpHome != null && vpHome.getCurrentItem() == 0) {
            if (liveUserFragment != null) {
                liveUserFragment.refreshData();
            }
        } else if (vpHome != null && vpHome.getCurrentItem() == 1) {
            if (liveManagerFragment != null) {
                liveManagerFragment.refreshData();
            }
        } else if (vpHome != null && vpHome.getCurrentItem() == 2) {
            if (liveBanFragment != null) {
                liveBanFragment.refreshData();
            }
        }
    ...
    private void initTab() {
        ...
        if (mType == 1) {
            mTitles.add("全部");
            mTitles.add(getString(R.string.st_manager_list));
        }

        mTitles.add(getString(R.string.st_ban_list));
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                CommonNavigatorUtils.initTitleView(simplePagerTitleView, context, mTitles.get(index),
                        R.color.white, R.color.white, 16);
            ...
            public IPagerIndicator getIndicator(Context context) {
                ...
                return CommonNavigatorUtils.initLine(context, 20, 0, R.color.white);
            }
    ...
    private void initFragment() {
        ...
        if (mType == 1) {
            liveUserFragment = new LiveUserFragment(mAnchorId);
            liveManagerFragment = new LiveManagerFragment();
            mFragments.add(liveUserFragment);
            mFragments.add(liveManagerFragment);
        }
        liveBanFragment = new LiveBanFragment(mAnchorId);
        mFragments.add(liveBanFragment);
