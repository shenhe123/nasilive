...
import com.feicui365.live.ui.adapter.ImChatFaceAdapter;
 ...
 * 横屏表情
 * */
public class ImChatFacePagerHorizontalAdapter extends PagerAdapter {

    private static final int FACE_COUNT = 41;//每页20个表情
    private List<View> mViewList;

    public ImChatFacePagerHorizontalAdapter(Context context, OnFaceClickListener onFaceClickListener) {
        ...
        for (int i = 0; i < pageCount; i++) {
            ...
            recyclerView.setLayoutManager(new GridLayoutManager(context, 14, GridLayoutManager.VERTICAL, false));
